...
def yolov5_use(
    ...
    #print(len(det))
    if len(det)!=0: return im0,result_f_re,result_soft_re  
    else:
       im0=0
       result_f_re=0
       result_soft_re=0
       return im0,result_f_re,result_soft_re
...
if __name__ == '__main__':
    ...
    save_txt=False
    nosave=True
    im0,classfinal,result_soft=yolov5_use(weights,source,imgsz,save_txt,nosave)
    print(im0.shape)
